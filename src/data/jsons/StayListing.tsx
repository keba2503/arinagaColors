...
const listings = [
    {
        ...
        description: "Vivienda de 90 m2, con tres dormitorios. Ideal para familias de hasta 6 personas.",
        commentCount: 47,
        viewCount: 843,
        like: true,
    ...
    },
    {
        ...
        description: "Vivienda de 90 m2 con dos dormitorios. Fantástica para parejas o familias de hasta 4 miembros.",
        commentCount: 47,
        viewCount: 843,
        like: true,
        address: "Playa Arinaga",
    ...
    },
    {
        ...
        description: "Ático de 40 m2 con un dormitorio. Pensado para el máximo disfrute de una pareja.",
        commentCount: 47,
        viewCount: 843,
        like: true,
        address: "Playa Arinaga",
