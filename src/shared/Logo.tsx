...
const Logo: React.FC<LogoProps> = ({ img = logoImg, imgLight = logoLightImg, className = "", height = "80", width = "80" }) => {
    return (
        <Link href="/" className={`ttnc-logo inline-block focus:outline-none focus:ring-0 ${className}`}>
            {img ? (
