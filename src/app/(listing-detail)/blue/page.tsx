            ...
            <div className="listingSection__wrap !space-y-6">
                ...
                <div
                    ...
                    <div className="flex items-center space-x-3 ">
                        ...
                        <span className="">
              3 <span className="hidden sm:inline-block">huespedes</span>
            </span>
                    </div>
                    <div className="flex items-center space-x-3">
        ...
        return (
            <div className="listingSection__wrap">
                ...
                <span className="block mb-4">
                    Preciosa y acogedora vivienda vacacional en la Playa de Arinaga, en primera línea de playa con impresionantes vistas al mar y a toda la bahía. Consta de 1 dormitorio doble y otro pequeño dormitorio contiguo, separado por una cristalera, con sofá cama. Tiene una capacidad para 3 personas.
                </span>
                    <span className="block mb-4">
                    La vivienda tiene una superficie de 48 m², exterior con mucha luz y está situada en primera línea de playa, con vistas al mar. Dispone de 8 m² de terraza con mobiliario, ideal para relajarse contemplando y escuchando el sonido del mar. Se encuentra totalmente equipado, con plancha, acceso ilimitado y gratuito a internet (wifi), secador de pelo y televisor. La cocina, de estilo americana, cuenta con placa vitrocerámica, horno, microondas, nevera y congelador, cafetera Nespresso, tostadora, cafetera de filtro, hervidor de agua y exprimidor. Ofrecemos cuna bajo petición, de manera gratuita.
                </span>
                    <span className="block mb-4">
        ...
        return (
            <div className="listingSection__wrap">
                ...
                <div className="flex justify-center mt-6">
                    <iframe
                        src="https://www.avaibook.com/widgets_propietarios/opiniones.php?cod_propietario=92477&cod_alojamiento=357500&subtipo=2&color_texto=000000&lang=es"
        ...
        return (
            <div className="listingSectionSidebar__wrap shadow-xl p-4 lg:p-6">
                <div
                    ...
                    data-border-radius="3px" data-shadow="0 2px 20px rgb(0 0 0 / 16%)" data-padding="1rem" data-language="es"></div>
            </div>
        );
    };
